...
const partsData = [
    {
        ...
        url: 'https://akirabox.to/2bJG8pa60GOB/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '2.93 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/E1x3AavBd3yk/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '2.93 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/rk9zKwpZ4z0l/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part4',
        name:  'الجزء الرابع',
        size: '2.73 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/l76mZ2dnxman/file' // استبدل برابط التحميل الفعلي
    }
...
class PartsDownloader {
    ...
    displayFileInfo() {
        this.fullFileNameDisplay.textContent = 'Watch Dogs 2 update.pkg'; // اسم ملف افتراضي
