...
const partsData = [
    {
        ...
        url: 'https://akirabox.to/dZxG5ZEoemVj/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/LK0G1e6beG91/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/2bJG8pgbqGOB/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part4',
        name: 'الجزء الرابع',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/jar3XqMlZz2d/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part5',
        name: 'الجزء الخامس',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/5pVzNP7AAm7w/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part6',
        name: 'الجزء السادس',
...
class PartsDownloader {
    ...
    displayFileInfo() {
        ...
        partsData.forEach(part => {
            ...
            const sizeValue = parseFloat(part.size.replace('66 GB', ''));
            if (!isNaN(sizeValue)) {
