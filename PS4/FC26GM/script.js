...
const partsData = [
    {
        ...
        url: 'https://akirabox.to/b5OzdRNn9mB8/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '2.93 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/RMKGJkgbLm1o/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '2.93 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/0rpmv7OVy3Rg/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part4',
        name:  'الجزء الرابع',
        size: '2.93 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/EL73gjLNam9B/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part5',
        name: 'الجزء الخامس',
        size: '2.93 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/l5YzMwJM9myO/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part6',
        name: 'الجزء السادس',
        size: '219.67 MB', // تم التعديل إلى GB
        url: 'https://akirabox.to/BnkmWVK86GR0/file' // استبدل برابط التحميل الفعلي
    }
...
class PartsDownloader {
    ...
    displayFileInfo() {
        this.fullFileNameDisplay.textContent = 'Fc 26 game.pkg'; // اسم ملف افتراضي
        
        let totalSizeGB = 0;
        partsData.forEach(part => {
            // التأكد من أن الحجم بصيغة 'X.XX GB' واستخراج القيمة الرقمية
            const sizeValue = parseFloat(part.size.replace('14 GB', ''));
            if (!isNaN(sizeValue)) {
