...
const partsData = [
    {
        ...
        url: 'https://akirabox.to/E9Qz91yQJzOL/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/M2BGww50PGj4/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '6.54 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/qPez4qlbYGOY/file' // استبدل برابط التحميل الفعلي
    }
...
class PartsDownloader {
    ...
    displayFileInfo() {
        this.fullFileNameDisplay.textContent = 'Watch Dogs 2 Game.pkg'; // اسم ملف افتراضي
        
        let totalSizeGB = 0;
        partsData.forEach(part => {
            // التأكد من أن الحجم بصيغة 'X.XX GB' واستخراج القيمة الرقمية
            const sizeValue = parseFloat(part.size.replace('26.07 GB', ''));
            if (!isNaN(sizeValue)) {
