...
const partsData = [
    {
        ...
        url: 'https://akirabox.to/Z9dzBjEYMzk1/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/ZvqzlYjK5GaD/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/APVmaJO1w3Xo/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part4',
        name: 'الجزء الرابع',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/jar3XqBMZz2d/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part5',
        name: 'الجزء الخامس',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/jJD3VVg103a5/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part6',
        name: 'الجزء السادس',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/ex5z2koLeGKq/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part7',
        name: 'الجزء السابع',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/jar3XqBb2z2d/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part8',
        name: 'الجزء الثامن',
        size: '7.58 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/LK0G1eMXZG91/file' // استبدل برابط التحميل الفعلي
    },
...
class PartsDownloader {
    ...
    displayFileInfo() {
        this.fullFileNameDisplay.textContent = 'eFootball PES 2026 Monster Patch Game.pkg'; // اسم ملف افتراضي
        
        let totalSizeGB = 0;
        partsData.forEach(part => {
            // التأكد من أن الحجم بصيغة 'X.XX GB' واستخراج القيمة الرقمية
            const sizeValue = parseFloat(part.size.replace('77 GB', ''));
            if (!isNaN(sizeValue)) {
