...
const partsData = [
    {
        ...
        url: 'https://akirabox.to/Z9dzBjnp5zk1/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/qw1zeJLlvGXy/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/b5OzdRNO9mB8/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part4',
        name:  'الجزء الرابع',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/qLQ36pnOYG19/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part5',
        name: 'الجزء الخامس',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/E9Qz91nBrzOL/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part6',
        name: 'الجزء السادس',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/Y2xm0DnE6mRO/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part7',
        name: 'الجزء السابع',
        size: '1.98 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/qLQ36pn8lG19/file' // استبدل برابط التحميل الفعلي
    }
...
class PartsDownloader {
    ...
    displayFileInfo() {
        this.fullFileNameDisplay.textContent = 'Fc 26 update.pkg'; // اسم ملف افتراضي
        
        let totalSizeGB = 0;
        partsData.forEach(part => {
            // التأكد من أن الحجم بصيغة 'X.XX GB' واستخراج القيمة الرقمية
            const sizeValue = parseFloat(part.size.replace('60 GB', ''));
            if (!isNaN(sizeValue)) {
