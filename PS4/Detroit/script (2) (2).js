...
const partsData = [
    {
        id: 'part1',
        name: 'الجزء الأول',
        size: '5.00 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/LJlGnqe7jz15/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '5.00 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/LJlGnqeZjz15/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '5.00 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/0rpmv7WgL3Rg/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part4',
        name:  'الجزء الرابع',
        size: '5.00 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/gXeGOR9b6zAa/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part5',
        name: 'الجزء الخامس',
        size: '5.00 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/ZvqzlYeZOGaD/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part6',
        name: 'الجزء السادس',
        size: '5.00 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/0rpmv7WyJ3Rg/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part7',
        name: 'الجزء السابع',
        size: '5.00 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/b5OzdReyOmB8/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part8',
        name:  'الجزء الثامن',
        size: '4.63 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/dZxG5ZVBKmVj/file' // استبدل برابط التحميل الفعلي
    }
...
class PartsDownloader {
    ...
    displayFileInfo() {
        this.fullFileNameDisplay.textContent = 'Detroit game.pkg'; // اسم ملف افتراضي
        
        let totalSizeGB = 0;
        partsData.forEach(part => {
            // التأكد من أن الحجم بصيغة 'X.XX GB' واستخراج القيمة الرقمية
            const sizeValue = parseFloat(part.size.replace('40 GB', ''));
            if (!isNaN(sizeValue)) {
