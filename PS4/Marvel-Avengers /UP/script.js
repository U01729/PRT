...
const partsData = [
    {
        ...
        url: 'https://akirabox.to/qPez4qvAMGOY/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/Y2xm0DeoLmRO/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/Xkrzoq5KWmBO/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part4',
        name: 'الجزء الرابع',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/E9Qz91xXWzOL/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part5',
        name: 'الجزء الخامس',
        size: '4.47 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/N2p3DJ7QdGMa/file' // استبدل برابط التحميل الفعلي
    }
...
class PartsDownloader {
    ...
    displayFileInfo() {
        this.fullFileNameDisplay.textContent = 'Marvel Avengers Game.pkg'; // اسم ملف افتراضي
        
        let totalSizeGB = 0;
        partsData.forEach(part => {
            // التأكد من أن الحجم بصيغة 'X.XX GB' واستخراج القيمة الرقمية
            const sizeValue = parseFloat(part.size.replace('44 GB', ''));
            if (!isNaN(sizeValue)) {
