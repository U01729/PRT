...
const partsData = [
    {
        ...
        url: 'https://akirabox.com/dZxG5Zr8YmVj/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '9.90 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/vgKGxop44z8Q/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '9.90 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/l76mZ2oaZman/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part4',
        name:  'الجزء الرابع',
        size: '9.90 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/Y2xm0DNkLmRO/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part5',
        name: 'الجزء الخامس',
        size: '8.31 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/5pVzNPjdAm7w/file' // استبدل برابط التحميل الفعلي
    }
...
class PartsDownloader {
    ...
    displayFileInfo() {
        this.fullFileNameDisplay.textContent = 'GTA 5 update 1.53.pkg'; // اسم ملف افتراضي
        
        let totalSizeGB = 0;
        partsData.forEach(part => {
            // التأكد من أن الحجم بصيغة 'X.XX GB' واستخراج القيمة الرقمية
            const sizeValue = parseFloat(part.size.replace('47.91 GB', ''));
            if (!isNaN(sizeValue)) {
