...
const partsData = [
    {
        ...
        url: 'https://akirabox.com/ex5z2kDbeGKq/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '9.90 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/7d5GLEYvbmxR/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '9.90 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/9AqGQRQoJmMn/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part4',
        name:  'الجزء الرابع',
        size: '9.90 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/2WVGrQg4Bzkx/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part5',
        name: 'الجزء الخامس',
        size: '3.36 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/dZxG5Zr6NmVj/file' // استبدل برابط التحميل الفعلي
    }
...
class PartsDownloader {
    ...
    displayFileInfo() {
        this.fullFileNameDisplay.textContent = 'GTA 5 game.pkg'; // اسم ملف افتراضي
        
        let totalSizeGB = 0;
        partsData.forEach(part => {
            // التأكد من أن الحجم بصيغة 'X.XX GB' واستخراج القيمة الرقمية
            const sizeValue = parseFloat(part.size.replace('42.96 GB', ''));
            if (!isNaN(sizeValue)) {
