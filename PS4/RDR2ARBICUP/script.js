...
const partsData = [
    {
        ...
        url: 'https://akirabox.to/E1x3Aa5vn3yk/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '9.77 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/qw1zeJWwjGXy/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '1.63 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/0PdzyWppPmeA/file' // استبدل برابط التحميل الفعلي
    }
...
class PartsDownloader {
    ...
    displayFileInfo() {
        this.fullFileNameDisplay.textContent = 'Red Dead Redemption 2 Arabic UPDATE.pkg'; // اسم ملف افتراضي
